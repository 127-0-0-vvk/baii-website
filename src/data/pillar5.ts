...
export const PILLAR5_YEARS: Year[] = [
  {
    ...
    modules: [
      { id:"m1", title:"Observation", weeks:"Wk 1–7", subtitle:"What am I actually seeing vs assuming?", weeks_detail:[
        ...
        {w:"W3",topic:"Memory is Not a Recording",concept:"Memory is reconstructive, not playback. Why two people remember the same event differently.",exercise:"Read a story. Wait 10 mins. Answer 10 questions without re-reading. Where did memory fail?",example:"Family members at the same wedding remember different things. Who is 'right'?",days:[
          {
            day:1,label:"Monday",title:"Watch, Then Remember",
            video_url:"https://www.youtube.com/embed/Pnl-S-9udT4",
            video_note:"A short walk through New Delhi. Watch ONCE — no notes, no rewinding.",
            instructions:"Watch the video once. Don't write anything while watching. Then come back.",
            prompt:"Without watching again, write 10 things you remember from the video.\n\nThen mark each one:\n✓ if you are SURE you saw it\n? if you are not fully sure\n\nMemory fades fast — being honest about the '?' ones is the real skill.",
            min_words:40,
            grading_criteria:"Day 1 of 'Memory is Not a Recording'. Reward an honest recall list of ~10 items AND marking how sure they are. The lesson is that memory is imperfect, so reward honesty about uncertainty over a long confident list. Class 6 — be warm.",
          },
          {
            day:2,label:"Tuesday",title:"The Story Test",
            read:"Read this ONCE, then do NOT scroll back up:\n\"On Sunday morning, Meena went to the market with her grandfather. She bought 2 kg of tomatoes and a yellow umbrella. On the way home it began to rain, so they shared the umbrella. Grandfather slipped near the temple but did not fall.\"",
            instructions:"Read the story above once, then answer from memory — no peeking.",
            prompt:"From memory only:\n1) What day was it?\n2) Who did Meena go with?\n3) What two things did she buy?\n4) What colour was the umbrella?\n5) What happened near the temple?\n\nThen write one line: which answer were you LEAST sure about, and why?",
            min_words:35,
            grading_criteria:"Answers: Sunday; grandfather; 2 kg tomatoes + a yellow umbrella; yellow; he slipped but did not fall. Reward honest recall and especially honesty about which detail was fuzzy — memory naturally drops details. Encourage; a few mistakes are expected and fine.",
          },
          {
            day:3,label:"Wednesday",title:"Two Witnesses",
            read:"Two friends describe the SAME moment in a cricket match:\nRahul: \"He was clearly OUT — the ball hit his pad right in front of the stumps.\"\nAisha: \"No! The ball touched the bat first, I heard the sound. NOT out.\"",
            instructions:"Both friends are being honest. Read carefully and answer.",
            prompt:"1) List 3 differences between Rahul's and Aisha's accounts.\n2) Can BOTH of them be honest and still remember it differently? Explain why in 1–2 sentences.\n3) What ONE piece of evidence would settle it fairly?",
            min_words:45,
            grading_criteria:"Reward understanding that two honest people can remember the same event differently (memory isn't a recording), and naming fair evidence to settle it (TV replay, ultra-edge/snicko, third umpire). Discourage simply picking a 'side'. Class 6 level.",
          },
          {
            day:4,label:"Thursday",title:"Your Own Memory",
            instructions:"Think about a real family event from the last month — a meal, a trip, a festival.",
            prompt:"1) Write 3 things you are SURE happened at that event.\n2) Write 2 things you are NOT sure about.\n3) Who else was there that you could ask to check your memory?",
            min_words:45,
            grading_criteria:"Reward honest separation of 'sure' vs 'unsure' memories and naming a real person to verify with. The skill is humility about one's own memory. Be warm and encouraging.",
          },
          {
            day:5,label:"Friday",title:"Week 3 Wrap-Up",
            instructions:"Finish Week 3 thoughtfully.",
            prompt:"1) In your own words, why is memory NOT like a video recording? (2–3 sentences)\n2) Write about one time your memory turned out to be wrong: \"I remembered ___ , but really ___ .\"\n3) Finish: \"Now, before I trust a memory, I will ___.\"",
            min_words:50,
            grading_criteria:"Week 3 wrap-up. Reward a clear explanation that memory is rebuilt (not replayed), an honest personal example, and a sensible habit (check with others/evidence). Celebrate growth — Class 6.",
          },
        ]},
        {w:"W4",topic:"Numbers Lie If You Let Them",concept:"Percentage vs absolute numbers. Cherry-picking. Questions to ask when you see a statistic.",exercise:"3 real Indian ads with statistics. For each: what questions would a detective ask?",example:"'Crime increased 100%!' — from 1 case to 2 cases. Technically true, completely misleading.",days:[
          {
            day:1,label:"Monday",title:"Big Number, Small Story",
            read:"A number can be TRUE and still trick you.\nExample: \"Crime went up 100%!\" sounds scary — but it went from 1 case to 2 cases. True… and almost meaningless.\nAlways ask: 100% of WHAT? Out of how many?",
            instructions:"Read the lesson above, then judge each statement.",
            prompt:"For each statement, write whether it is SCARY-BUT-MISLEADING or GENUINELY-BIG, and one line why:\n\n1. \"Sales doubled!\" (from 5 phones to 10 phones)\n2. \"90% of 50,000 patients recovered.\"\n3. \"Accidents rose 200%!\" (from 1 to 3)\n4. \"4 out of 5 dentists recommend it.\" (they asked only 5 dentists)\n5. \"1,00,000 people use our app every day.\"",
            min_words:40,
            grading_criteria:"Day 1 of 'Numbers Lie'. Misleading: 1 (tiny base), 3 (tiny base), 4 (tiny sample). Genuinely big: 2 (large sample, high rate), 5 (large absolute number). Reward spotting that a percentage means nothing without the base/sample size. Class 6 — reward the reasoning even if a label is off.",
          },
          {
            day:2,label:"Tuesday",title:"Turn the Scary Headline into Real Numbers",
            read:"Detectives convert percentages back into real counts to see the truth.\n'100% increase' = it doubled. From 1 → 2. From 50 → 100.",
            instructions:"Work out the REAL numbers behind each headline.",
            prompt:"For each headline, write the actual numbers and whether you'd be worried:\n\n1) \"Tiger attacks up 100% this year!\" — last year there was 1 attack. How many this year?\n2) \"Our school's toppers increased 50%!\" — last year 2 toppers. How many now?\n3) \"Phone thefts DOWN 25%!\" — last year 80 thefts. How many now?\n\nThen write: which headline sounds scariest but is actually the smallest change?",
            min_words:40,
            grading_criteria:"Answers: 1) 2 attacks; 2) 3 toppers; 3) 60 thefts. The 'scariest but smallest' is the tiger one (1→2). Reward correct arithmetic and the insight that % hides the real size. Encourage; partial credit for good reasoning.",
          },
          {
            day:3,label:"Wednesday",title:"Questions a Detective Asks",
            read:"An advertisement says: \"Clinically proven! 95% of users saw fairer skin in just 2 weeks.\"",
            instructions:"Be the detective. Don't accept the number — interrogate it.",
            prompt:"Write 4 questions you would ask before believing this ad. Think about:\n• How many people were tested?\n• Who paid for the test?\n• What does 'fairer' even mean — who decided?\n• Were there people it did NOT work for?\n\nWrite your 4 questions in your own words.",
            min_words:40,
            grading_criteria:"Reward 4 genuine investigative questions about sample size, funding/bias, vague terms, and missing failures. Class 6 — reward curiosity and skepticism, not perfect wording.",
          },
          {
            day:4,label:"Thursday",title:"Find a Number in the Wild",
            instructions:"Find ONE number, statistic, or percentage from a real place — a TV ad, a news headline, a packet, a poster, a YouTube thumbnail.",
            prompt:"1) Write the exact claim/number you found, and where you saw it.\n2) What is it trying to make you believe or do?\n3) Write 2 detective questions you'd ask before trusting it.\n4) Out of 10, how much do you trust it — and why?",
            min_words:45,
            grading_criteria:"Reward using a real example they found, identifying its persuasive goal, asking 2 sensible checking questions, and giving a reasoned trust score. Accept any genuine real-world number. Encourage.",
          },
          {
            day:5,label:"Friday",title:"Week 4 Wrap-Up",
            instructions:"Finish Week 4.",
            prompt:"1) In your own words, why can a number be 100% true and still be misleading? (2–3 sentences)\n2) Write the ONE question you think is most powerful to ask about any statistic.\n3) Finish: \"Next time someone shows me a big percentage, I will first ___.\"",
            min_words:50,
            grading_criteria:"Week 4 wrap-up. Reward understanding of base/sample-size tricks, a strong go-to question ('out of how many?'), and a sensible habit. Celebrate growth — Class 6.",
          },
        ]},
        {w:"W5",topic:"Photos Can Lie",concept:"Cropping, angle, context removal, old photos for new stories. How to reverse image search.",exercise:"5 viral Indian photos — find original context of each. Was the attached claim true?",example:"2008 Kerala flood photo shared as 'today's Mumbai flood.'",days:[
          {
            day:1,label:"Monday",title:"A Photo Only Shows a Slice",
            read:"A camera only captures ONE slice of a moment — one angle, one second, with everything else cut away.\nImagine a photo: a boy holding a cricket bat, looking angry, a broken window behind him.\nThe caption says: \"Boy breaks neighbour's window!\"",
            instructions:"Look only at what the photo actually shows.",
            prompt:"About the photo described above:\n1) Write 3 things the photo actually SHOWS (facts).\n2) Write 3 things the caption wants you to ASSUME but the photo does NOT prove.\n3) Give one other innocent story that fits the same photo.",
            min_words:45,
            grading_criteria:"Reward separating what a photo proves (a boy, a bat, a broken window) from what the caption makes you assume (that HE broke it, that he's guilty, that he's angry about it). Reward a fair alternative story (e.g. he found it broken). Class 6 — reward fairness.",
          },
          {
            day:2,label:"Tuesday",title:"Old Photo, New Lie",
            read:"A very common trick: take a REAL old photo and attach a NEW false story.\nExample: a dramatic flood photo from Kerala in 2018 gets shared in 2024 as \"Mumbai underwater TODAY!\" The photo is real — the story is fake.",
            instructions:"Read the example, then answer.",
            prompt:"1) In your own words, how can a photo be 100% real but the message still be a lie?\n2) A scary photo arrives on WhatsApp saying \"This happened in our city today!\". Write 3 questions you'd ask before believing it.\n3) Where could you check if a photo is old?",
            min_words:45,
            grading_criteria:"Reward understanding the 'real photo, fake context' trick, 3 sensible checking questions (when/where was it taken? who first posted it? is it from another year?), and mentioning checking (reverse image search / asking when-where). Class 6 level.",
          },
          {
            day:3,label:"Wednesday",title:"Same Scene, Two Captions",
            read:"The SAME photo can be framed two opposite ways.\nPhoto: a politician handing a food packet to a child.\nCaption A: \"Kind leader feeds the hungry!\"\nCaption B: \"Staged photo for votes!\"",
            instructions:"Look at what's actually proven vs what each caption adds.",
            prompt:"1) What does the photo actually PROVE? (just the facts)\n2) What does Caption A want you to feel/assume?\n3) What does Caption B want you to feel/assume?\n4) What information would you need to know which caption is fairer?",
            min_words:45,
            grading_criteria:"Reward noticing the photo only proves the action (a packet handed over), while each caption adds motive/feeling that isn't proven. Reward asking for context (was it one-off for cameras? part of real ongoing work?). Reward fairness over picking a side.",
          },
          {
            day:4,label:"Thursday",title:"How to Check a Viral Photo",
            read:"Detective tools for photos:\n1) Reverse image search (Google Images / TinEye) — find where else the photo appeared.\n2) Ask: when and where was it really taken?\n3) Look for clues IN the photo (signboards, language, weather, clothes).",
            instructions:"Practice the checking mindset.",
            prompt:"A photo shows a snowy street, shared as \"Snowfall in Chennai!\".\n1) Why should you be suspicious straight away? (think about Chennai's weather)\n2) Name 2 clues inside a photo that could reveal the real place.\n3) Write the exact steps you'd take to check if this photo is real and recent.",
            min_words:45,
            grading_criteria:"Reward common-sense suspicion (Chennai is hot — snow is unlikely), naming in-photo clues (language on signs, number plates, clothing, trees), and listing checking steps (reverse image search, check date/source). Class 6 — reward the detective habit.",
          },
          {
            day:5,label:"Friday",title:"Week 5 Wrap-Up",
            instructions:"Finish Week 5.",
            prompt:"1) In your own words, name 2 ways a photo can mislead even if it is real. (2–3 sentences)\n2) Write about a photo or video you once believed that turned out to be misleading — or one you now realise you should double-check.\n3) Finish: \"Before I believe or forward a photo, I will ___.\"",
            min_words:50,
            grading_criteria:"Week 5 wrap-up. Reward naming real ways photos mislead (cropping/angle, old-photo-new-story, framing captions), a thoughtful personal reflection, and a sensible checking habit. Celebrate growth — Class 6.",
          },
        ]},
        {w:"W6",topic:"First Impression Bias",concept:"Anchoring bias — first number heard affects all future judgment. How to slow down thinking.",exercise:"Price guessing game — see high number first vs low number. How does anchoring change guesses?",example:"'This phone was ₹50,000, now only ₹30,000!' — did the original price actually matter?",days:[
          {
            day:1,label:"Monday",title:"The First Number Sticks",
            read:"Your brain grabs the FIRST number it hears and quietly measures everything against it. This is called 'anchoring'.\nA shop says: \"Worth ₹50,000 — today only ₹30,000!\" Suddenly ₹30,000 feels cheap… but only because of the ₹50,000 they put in your head first.",
            instructions:"Read the lesson, then answer honestly.",
            prompt:"1) If the shop had just said \"This phone costs ₹30,000\" (no ₹50,000), would it feel as cheap? Why?\n2) Does the old ₹50,000 price actually tell you if ₹30,000 is a good deal? What WOULD tell you?\n3) Describe one time a 'first number' (a price, a score, a rating) changed how you judged something.",
            min_words:45,
            grading_criteria:"Day 1 of 'First Impression Bias'. Reward understanding that the first number anchors judgement, that the old price doesn't prove value (comparing other shops/real worth does), and a genuine personal example. Class 6 — encourage.",
          },
          {
            day:2,label:"Tuesday",title:"Anchors Everywhere",
            read:"Anchors aren't only prices. A first impression of a PERSON works the same way — the first thing you notice colours everything after.",
            instructions:"Spot the anchor in each situation.",
            prompt:"For each, write what the ANCHOR is and how it might unfairly change a judgement:\n1) A new student arrives late on day one.\n2) A restaurant menu lists a ₹2,000 dish at the top, then a ₹600 dish.\n3) A movie has \"9/10!\" printed on its poster.\n4) Someone says \"my friend is a bit weird\" before you meet them.",
            min_words:45,
            grading_criteria:"Reward identifying the anchor in each (late arrival → 'careless'; ₹2,000 → makes ₹600 feel cheap; 9/10 → expect greatness; 'weird' → biased first meeting) and how it can mislead a fair judgement. Class 6 level.",
          },
          {
            day:3,label:"Wednesday",title:"Give a Fair First Impression",
            read:"We can't stop our brain from forming first impressions — but we CAN slow down and give people a fair chance.",
            instructions:"Practise fairness and positivity.",
            prompt:"Think of a time you judged a person quickly and were later proven wrong.\n1) Write: \"At first I thought ___ about them.\"\n2) Write: \"Later I learned ___.\"\n3) What made you change your mind?\n4) Finish kindly: \"A fair way to treat someone new is ___.\"",
            min_words:50,
            grading_criteria:"Reward an honest example of a wrong first impression being corrected, what changed it, and a kind, fair principle for treating new people. This builds positivity and fairness. Do NOT reward harsh judgements. Class 6 — warm tone.",
          },
          {
            day:4,label:"Thursday",title:"Slow Down Your Thinking",
            read:"The cure for anchoring is to PAUSE and ask for the real facts before deciding.",
            instructions:"Build your own 'slow down' habit.",
            prompt:"For each, write the ONE question that would help you decide fairly instead of trusting the anchor:\n1) \"Was ₹50,000, now ₹30,000!\"\n2) \"Top-rated 9/10 movie!\"\n3) A boy is quiet on the first day — \"he's unfriendly\".\n\nThen write your own 2-step rule for slowing down before you judge.",
            min_words:45,
            grading_criteria:"Reward good fact-seeking questions (what do OTHER shops charge? who rated it and how many? has he had a chance to talk yet?) and a sensible personal 'pause-and-check' rule. Class 6 — encourage.",
          },
          {
            day:5,label:"Friday",title:"Week 6 Wrap-Up",
            instructions:"Finish Week 6.",
            prompt:"1) In your own words, what is anchoring (first-impression bias)? Give one example. (2–3 sentences)\n2) Write about a first impression of yours that turned out to be unfair or wrong.\n3) Finish: \"To judge people and prices more fairly, I will ___.\"",
            min_words:50,
            grading_criteria:"Week 6 wrap-up. Reward a clear explanation of anchoring with an example, an honest reflection on a wrong first impression, and a fair habit going forward. Celebrate fairness and growth — Class 6.",
          },
        ]},
        {w:"W7",topic:"Module 1 Challenge",concept:"Apply all Module 1 skills to one real viral WhatsApp forward.",exercise:"List every assumption, identify observation vs claim, spot misleading numbers or photos. Tutor session.",example:"Tutor asks: 'What would change your verdict about this forward?'",days:[
          {
            day:1,label:"Monday",title:"Meet the Forward",
            read:"This week you become a full Truth Detective on ONE real-style message. Here it is — read it carefully:\n\n\"😱 SHOCKING! Eating Maggi causes 90% of stomach problems in children. A photo shows noodles next to an X-ray. Doctors are HIDING this. Crime cases from junk food rose 200% this year! Forward to 10 parents NOW to protect kids!\"",
            instructions:"Read the forward above. Today, just take it apart into pieces.",
            prompt:"Break the message into separate claims. List every SEPARATE thing it is asking you to believe (there are several). Number them.",
            min_words:40,
            grading_criteria:"Module 1 Challenge, Day 1. Reward breaking the forward into its separate claims: (a) Maggi causes 90% of stomach problems, (b) the X-ray/photo proves it, (c) doctors are hiding it, (d) junk-food crime up 200%, (e) you must forward to 10 people. Reward thoroughness. Class 6 — encourage.",
          },
          {
            day:2,label:"Tuesday",title:"Observation vs Claim",
            read:"Use the SAME forward from Monday (the Maggi message).",
            instructions:"Separate proven facts from unproven claims.",
            prompt:"From the Maggi forward:\n1) Does it give any REAL evidence (a named study, a real doctor, a date, a source)? List anything real you can find.\n2) List 3 CLAIMS it states as if they are facts but does not prove.\n3) Which single word or emoji is there only to scare you, not to inform you?",
            min_words:45,
            grading_criteria:"Reward noticing there is NO real evidence (no named study/doctor/source), listing unproven claims, and spotting fear devices ('SHOCKING', '😱', 'NOW'). Class 6 level — reward the detective mindset.",
          },
          {
            day:3,label:"Wednesday",title:"Hunt the Tricks",
            read:"Use the SAME Maggi forward. Now hunt for the specific tricks from Module 1.",
            instructions:"Find the number trick and the photo trick.",
            prompt:"1) The forward says '90%' and '200%'. Why are these numbers suspicious? What's missing? (think: out of how many? from what to what?)\n2) It shows 'noodles next to an X-ray'. Does that photo actually PROVE noodles caused anything? Explain.\n3) Name one assumption the forward wants you to make about 'doctors'.",
            min_words:45,
            grading_criteria:"Reward spotting that the percentages have no base/source (90% of whom? 200% from what number?), that a photo of two things side by side proves no cause, and the hidden assumption ('doctors are hiding the truth'). This applies Weeks 4 & 5. Class 6.",
          },
          {
            day:4,label:"Thursday",title:"Write Your Verdict",
            read:"You've taken the forward apart all week. Time to deliver a clear verdict, like a real fact-checker.",
            instructions:"Write a short, clear verdict a Truth Detective would be proud of.",
            prompt:"Write your verdict on the Maggi forward (4–6 sentences):\n1) Your verdict: TRUE / FALSE / CAN'T TELL YET — and why.\n2) Your 2 strongest reasons.\n3) What real evidence WOULD make you take it seriously?\n4) Would you forward it? Why or why not?",
            min_words:55,
            grading_criteria:"Reward a clear verdict (FALSE or CAN'T-TELL with reasoning), strong reasons grounded in the week's skills (no evidence, misleading numbers, meaningless photo, fear tactics), naming what real proof would look like (a peer-reviewed study, named experts), and a sensible 'don't forward' decision. This is the core Module 1 skill. Be encouraging and celebrate good reasoning.",
          },
          {
            day:5,label:"Friday",title:"Module 1 Complete — Truth Detective",
            instructions:"You've finished Module 1: Observation! Reflect on how far you've come.",
            prompt:"Look back over Weeks 1–7.\n1) Name the 3 most useful things you learned to do (e.g. separate seeing from assuming, question numbers, check photos).\n2) Write about one real message, photo, or claim from your own life that you now see differently.\n3) Finish proudly: \"As a Truth Detective, before I believe something now, I ___.\"",
            min_words:55,
            grading_criteria:"Module 1 capstone reflection. Reward naming concrete skills from the module (observation vs assumption, fact vs opinion, memory limits, number tricks, photo tricks, anchoring), a real personal application, and a confident, positive closing habit. Celebrate the achievement warmly — they've finished their first module.",
          },
        ]},
      ]},
